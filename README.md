...
I hold a **bachelor’s degree in Computer Science from Universidade Paulista (UNIP)** and am based in São Paulo, Brazil. I have **1 year and 7 months of professional experience at FIPE**, working with economic data collection, cleaning, validation, analysis, automation and reporting.
...
| [Brazilian Income Analysis](https://github.com/MauricioTaguchi/analise-renda-brasil) | Reproducible pipeline using official IBGE/SIDRA data, coverage validation for all 27 Brazilian states, analytical layers, dashboard and executive summary     | Python, Pandas, SQL, Pytest, GitHub Actions       |
...
I am open to opportunities as a **Data Analyst**, **BI Analyst** or **Junior Analytics Engineer**, in Brazil or remotely. I work professionally in Portuguese and English.
